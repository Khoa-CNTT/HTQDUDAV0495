  ...
  const blogPosts = [
    {
      ...
      description: "Explore how artificial intelligence is revolutionizing the way we learn and teach in modern classrooms.",
      link: "#",
    ...
    },
    {
      ...
      description: "Learn the secrets to crafting quizzes that captivate and educate your audience effectively.",
      link: "#",
    ...
    },
    {
      ...
      description: "Discover the psychological benefits of regular quizzing and how it enhances knowledge retention.",
      link: "#",
    ...
    <div className="py-16">
      <div className="container mx-auto px-4">
        ...
        >
          <a
            href="#"
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-lg shadow-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 transform hover:-translate-y-1"
          >
            View All Articles
