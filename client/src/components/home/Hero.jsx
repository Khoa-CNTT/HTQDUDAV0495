  ...
  return (
    ...
    >
      ...
      <div className="z-10 flex flex-col items-center justify-center flex-1 text-center">
        <h1 className="max-w-4xl mx-auto text-5xl font-semibold tracking-tight font-display text-slate-9000 sm:text-7xl">
          The{" "}
          <span className="relative font-bold whitespace-nowrap text-primary-lighter">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
        ...
        <p class="mx-auto mt-6 max-w-[40rem] text-lg sm:text-xl tracking-tight text-slate-700 leading-relaxed font-normal ">
        ...
        <div className="inline-flex items-center justify-center px-8 py-3 mt-8 text-lg font-semibold text-white bg-teal-600 rounded-full shadow-lg group focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 hover:bg-teal-700 sm:py-4 hover:shadow-xl">
          {isLoggedIn ? (
