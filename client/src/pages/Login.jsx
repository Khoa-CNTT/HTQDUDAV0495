      ...
      <div className="create-room-card" style={{zIndex:1,position:'relative',maxWidth:540,padding:'2.5rem 2.5rem',margin:'48px auto'}}>
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          <div className="form-group">
            <label className="form-label" htmlFor="email" style={{color: '#ffe259'}}>
              Email
            </label>
            <input
              id="email"
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="password" style={{color: '#ffe259'}}>
              Password
            </label>
            <input
              id="password"
          ...
          <button type="submit" className="create-button" disabled={loading} style={{width:'100%',marginTop:16}}>
            {loading ? <div className="loading-spinner" style={{height:24,width:24}}></div> : "Sign In"}
          </button>
        </form>
        <div style={{marginTop:32,textAlign:'center'}}>
          <Link to="/forgot-password" className="auth-link" style={{color:'#ffe259',fontWeight:600,marginBottom:8,display:'inline-block'}}>
            Forgot password?
          </Link>
          <p style={{color:'#e0e7ff',marginTop:8}}>
            Don't have an account?{' '}
            <Link to="/register" className="auth-link" style={{color:'#f472b6',fontWeight:600}}>
              Sign up
            </Link>
          </p>
        </div>
